...
def main():
    driver = webdriver.Firefox()  #浏览器的地址
    ...
    #   imgs = bsObj.find_all("img", {"src": re.compile("\/\/gtd\.alicdn\.com\/imgextra.*\.jpg")})
    # 所有妹子的名字地点
    girlsNL = girlsList[::3]
    # 所有妹子的身高体重
    ...
    girlsInfo1 = list(zip(girlsNL, girlsHW, girlsHURL, girlsPhotoURL))

    girlsInfo = girlsInfo1[1:]
